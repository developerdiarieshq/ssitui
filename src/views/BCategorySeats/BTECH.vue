  ...
  <div class="btech-page">
    ...
    <header class="hero">
      <div class="container text-center">
        <h1 class="title">B.Tech</h1>
        <p class="subtitle">B-Category Seats Application Form</p>
      </div>
    </header>
    ...
    <div class="container">
      ...
      <div class="advertisement-section">
        <div class="advertisement-box">
          <h3><i class="fa-solid fa-bullhorn"></i> Important Notice</h3>
          ...
          <div class="advertisement-link-container">
            <button @click="openPdfModal('admission')" class="advertisement-link">
              <i class="fas fa-external-link-alt"></i>
              View B.Tech B-Category Seats Advertisement
            </button>
            <button @click="openPdfModal('application')" class="download-link">
      ...
      <div class="documents-section">
        <div class="documents-box">
          <h3><i class="fa-solid fa-clipboard-list"></i> DOCUMENTS / CERTIFICATES TO BE ENCLOSED</h3>
          <div class="documents-list">
            <div class="document-item">1. EAMCET 2025 Rank Card and Hall Ticket</div>
          ...
          <div class="fee-note">
            <p><strong>NOTE:</strong> College Fee is Rs.70,000/- per year.</p>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    openPdfModal(type) {
      ...
      if (type === 'admission') {
        this.currentPdfTitle = 'B.Tech B-Category Seats Advertisement 2025-26';
        this.currentPdfUrl = new URL('@/assets/departments/bcategory/btech/admission_25_26.pdf', import.meta.url).href;
      } else if (type === 'application') {
        this.currentPdfTitle = 'B.Tech Application Form 2025-26';
        this.currentPdfUrl = new URL('@/assets/departments/bcategory/btech/application_25_26.pdf', import.meta.url).href;
      }
    },
...
.advertisement-section, .documents-section {
  margin-bottom: 2rem;
}

.advertisement-box, .documents-box {
  background: var(--card);
  border-radius: 1rem;
  padding: 2rem;
...
.advertisement-box h3, .documents-box h3 {
  display: flex;
  align-items: center;
...
.advertisement-link, .download-link {
  display: inline-flex;
  align-items: center;
  gap: 0.5rem;
  color: white;
...
.download-link:hover {
  background: #0f172a;
  transform: translateY(-2px);
  box-shadow: 0 4px 12px rgba(26, 34, 56, 0.3);
}
