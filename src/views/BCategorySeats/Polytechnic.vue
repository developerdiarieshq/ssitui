        ...
        <div class="advertisement-box">
          ...
          <div class="advertisement-link-container">
            <button @click="openPdfModal('admission')" class="advertisement-link">
              ...
              View Polytechnic B-Category Seats Advertisement
            </button>
      ...
      <div class="documents-section">
        <div class="documents-box">
          ...
          <div class="documents-list">
            <div class="document-item">1. CEEP 2025 Rank Card and Hall Ticket</div>
            ...
            <div class="document-item">4. Diploma Provisional Certificate</div>
            <div class="document-item">5. Diploma Consolidated Marks Memo</div>
            <div class="document-item">6. Diploma Transfer Certificate</div>
            <div class="document-item">7. 9th to Diploma Study & Conduct Certificates</div>
          ...
          <div class="fee-note">
            <p><strong>NOTE:</strong> College Fee is Rs.14,900/- per year.</p>
          </div>
        </div>
      </div>
    </div>
