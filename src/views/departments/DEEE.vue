  ...
  <div class="dme-page">
    ...
    <header class="hero" role="banner" aria-label="DME Department Hero">
      ...
      <div class="container hero-inner">
        <div class="hero-copy">
          <h1 class="title">Diploma in Electrical & Electronics Engineering (DEEE)</h1>
          <p class="tagline">Powering the Future with Electrical Excellence</p>
    ...
    <main class="container content" id="content">
      ...
      <section :id="tabsMap.overview" class="card-section" v-show="activeTab==='overview'">
        ...
        <div class="grid-2">
          ...
          <article class="card">
            ...
            <ul class="bullets">
              <li><strong>Power Systems</strong> — Electrical power generation, transmission, and distribution</li>
              <li><strong>Electrical Machines</strong> — Motors, generators, and transformers</li>
              <li><strong>Control Systems</strong> — Automation and industrial control</li>
              <li><strong>Power Electronics</strong> — Modern electrical devices and circuits</li>
            </ul>
      ...
      <!-- CURRICULUM -->
      <section :id="tabsMap.curriculum" class="card-section" v-show="activeTab==='curriculum'">
        <div class="card">
...
const faculty = ref([
  {
    name: 'Dr. A. Reddy', designation: 'Professor & HOD',
    qualification: 'Ph.D., Electrical Engineering',
    expertise: ['Power Systems', 'Electrical Machines', 'Control Systems'],
    email: 'hod.deee@ssit.edu.in',
    photo: 'https://images.unsplash.com/photo-1544723795-3fb6469f5b39?q=80&w=400'
  },
  {
    name: 'Mr. K. Patel', designation: 'Assistant Professor',
    qualification: 'M.Tech (Electrical Engineering)',
    expertise: ['Power Electronics', 'Electrical Machines', 'Renewable Energy'],
    email: 'k.patel@ssit.edu.in',
    photo: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=400'
  },
  {
    name: 'Ms. S. Gupta', designation: 'Assistant Professor',
    qualification: 'M.Tech (Power Systems)',
    expertise: ['Power Systems', 'Control Systems', 'Industrial Automation'],
    email: 's.gupta@ssit.edu.in',
...
const hod = {
  name: 'Dr. A. Reddy',
  designation: 'Professor & Head, DEEE',
  location: 'Electrical Block, Room 301',
