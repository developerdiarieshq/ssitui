  ...
  <div class="dme-page">
    ...
    <header class="hero" role="banner" aria-label="DME Department Hero">
      ...
      <div class="container hero-inner">
        <div class="hero-copy">
          <h1 class="title">Diploma in Mechanical Engineering (DME)</h1>
          <p class="tagline">Practical Skills for Mechanical Excellence</p>
      ...
      <section :id="tabsMap.overview" class="card-section" v-show="activeTab==='overview'">
        ...
        <div class="grid-2">
          ...
          <article class="card">
            ...
            <ul class="bullets">
              <li><strong>Machine Design</strong> — Engineering design principles and CAD/CAM</li>
              <li><strong>Manufacturing</strong> — Production processes and quality control</li>
              <li><strong>Thermal Engineering</strong> — Heat transfer and energy systems</li>
              <li><strong>Workshop Practice</strong> — Hands-on training with modern equipment</li>
            </ul>
...
const faculty = ref([
  ...
  },
  {
    ...
    expertise: ['Thermal Engineering', 'Machine Design', 'Manufacturing'],
  ...
  },
  {
    ...
    expertise: ['Manufacturing', 'Quality Control', 'Industrial Engineering'],
...
const hod = {
  name: 'Dr. S. Kumar',
  designation: 'Professor & Head, DME',
  location: 'Mechanical Block, Room 201',
